...
/**
 * Plugin implementation of the studiometa_paragraph_field_formatter formatter.
 *
 * @FieldFormatter(
 *   id = "studiometa_paragraph_field_formatter",
 *   label = @Translation("Studiometa Paragraph Formatter"),
 *   field_types = {
 *     "entity_reference_revisions"
 *   }
 * )
 */
final class StudiometaParagraphFieldFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function settingsSummary() {
    $summary = [];
    $summary[] = $this->t('Récupère le formatter associé au type de paragraph du champ et génère uniquement les variables pour personnaliser le template.');
    return $summary;
  }
  ...
  public function viewElements(FieldItemListInterface $items, $langcode): array {
    ...
    foreach ($items as $delta => $item) {
      ...
      $formatter = $this->paragraphManager->getFormatter($entity, 'studiometa', '_paragraph');
